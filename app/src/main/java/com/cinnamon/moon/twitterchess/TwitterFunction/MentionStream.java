package com.cinnamon.moon.twitterchess.TwitterFunction;
...
/**
 * Created by moonp on 2018-03-23.
 */

public class MentionStream extends Thread{

    private TwitterStream stream;

    public MentionStream(TwitterStream stream){
        this.stream = stream;
    }
    ...
    private static final UserStreamListener listener = new UserStreamListener() {
        ...
        public void onStatus(Status status) {
            long id = status.getUserMentionEntities()[0].getId();
